...
{
    public class UIContext_TestOguzhan : MVCSContext
    {
        public UIContext_TestOguzhan (MonoBehaviour view) : base(view)
        {
        }

        public UIContext_TestOguzhan (MonoBehaviour view, ContextStartupFlags flags) : base(view, flags)
        {
        }
